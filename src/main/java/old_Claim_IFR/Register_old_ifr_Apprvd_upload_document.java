...
public class Register_old_ifr_Apprvd_upload_document extends Thanedlc 
...
{    
 ...
 //dependant family member
  ...
  //compartment no
      ...
      Thread .sleep(2000);
      driver().findElement(By.xpath(" //*[@id=\"ConfirmDocumentModal\"]/div/div/div[2]/button[2]")).click();  
